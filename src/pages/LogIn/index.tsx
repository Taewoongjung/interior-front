...
const LogIn = () => {
    ...
    return (
        <GlobalStyles>
            <WrapStyles className="login">
                <WrapStyles className="wrap">
                    <Toggle_Wrap id="toggle-wrap">
                        <Toggle_Terms_Div id="toggle-terms">
                            <Toggle_Terms id="cross">
                                <Toggle_Terms_Span></Toggle_Terms_Span>
                                <Toggle_Terms_Span></Toggle_Terms_Span>
                            </Toggle_Terms>
                        </Toggle_Terms_Div>
                    </Toggle_Wrap>
                    ...
                    <Recovery className="recovery">
                        ...
                        <form className="recovery-form" action="" method="post">
                            <input type="text" className="input" id="user_recover" placeholder="Enter Email or Username Here"/>
                                <ButtonStyles type="submit" className="button" value="Submit"/>
                        </form>
                            ...
                            <TabsContent className="tabs-content">
                                <div id="login-tab-content" className="active">
                                    <form className="login-form" action="#" method="post">
                                        ...
                                        <ButtonStyles type="submit" className="button" value="Login" />
                                    </form>
                                    <div className="help-action">
                                        <p><ArrowIcon className="fa fa-arrow-left" aria-hidden="true"/><a className="forgot" href="#">Forgot your password?</a></p>
                                    </div>
                                </div>
                                <div id="signup-tab-content">
                                    <form className="signup-form" action="#" method="post">
                                        ...
                                        <input type="password" className="input" id="user_pass" autoComplete="off" placeholder="Password" />
                                        <ButtonStyles type="submit" className="button" value="Sign Up" />
                                    </form>
                                    <div className="help-action">
                                        <p>By signing up, you agree to our</p>
                                        <p><ArrowIcon className="fa fa-arrow-left" aria-hidden="true"></ArrowIcon><a className="agree" href="#">Terms of service</a></p>
                                    </div>
                                </div>
                            </TabsContent>
                        </FormWrap>
