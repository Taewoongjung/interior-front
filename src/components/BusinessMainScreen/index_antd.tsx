...
import BusinessMaterialAddInputAntd from "./BusinessMaterialAddInput/index_antd";
                ...
                <Content style={{ background: 'white', padding: 48 }}>
                    <Row gutter={8} style={{ alignItems: 'center' }}>
                        ...
                        <Col>
                            ...
                            <Row>
                                <BusinessMaterialAddInputAntd businessIdParam={businessId} onEvent={handleMutate} />
                            </Row>
                        </Col>
                    </Row>
...
export default BusinessMainScreenAntd;